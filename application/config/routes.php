...
$route['employees/(:any)'] = 'employees/details/$1';

$route['jobs'] = 'jobs/index';
$route['jobs/finished'] = 'jobs/finished';
$route['jobs/create'] = 'jobs/create';
$route['jobs/update'] = 'jobs/update';
$route['jobs/finalize'] = 'jobs/finalize';
$route['jobs/statistics'] = 'jobs/statistics';
$route['jobs/(:any)'] = 'jobs/details/$1';

$route['partners'] = 'partners/index';
$route['partners/create'] = 'partners/create';
$route['partners/update'] = 'partners/update';
